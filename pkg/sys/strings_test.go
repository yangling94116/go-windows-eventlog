...
// stringToUTF16Bytes converts a string to UTF-16 bytes for testing purposes.
...
func TestUTF16BytesToString(t *testing.T) {
	input := "abc白鵬翔\U000145A6"
	utf16Bytes := stringToUTF16Bytes(input)
...
var _ = unsafe.Pointer(nil) // Ensure unsafe is imported for compatibility
