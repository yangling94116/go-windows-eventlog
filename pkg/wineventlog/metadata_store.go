...
func NewPublisherMetadataStore(session EvtHandle, provider string, locale uint32) (*PublisherMetadataStore, error) {
...
func NewEmptyPublisherMetadataStore(provider string) *PublisherMetadataStore {
...
func newPublisherMetadataCache(session EvtHandle, locale uint32) *publisherMetadataCache {
...
func (c *publisherMetadataCache) getPublisherStore(publisher string) (*PublisherMetadataStore, error) {
	...
	if !found {
		...
		md, err = NewPublisherMetadataStore(c.session, publisher, c.locale)
		if err != nil {
			...
			md = NewEmptyPublisherMetadataStore(publisher)
